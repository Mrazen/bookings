...
--
-- Name: room_restrictions_id_seq; Type: SEQUENCE; Schema: public; Owner: admin
--
...
ALTER TABLE public.room_restrictions_id_seq OWNER TO admin;

--
-- Name: room_restrictions_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: admin
--
...
--
-- Name: room_restrictions id; Type: DEFAULT; Schema: public; Owner: admin
--
...
--
-- Name: room_restrictions room_restrictions_pkey; Type: CONSTRAINT; Schema: public; Owner: admin
--
